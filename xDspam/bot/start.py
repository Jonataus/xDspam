...
btn = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("• Channel •", url="https://t.me/EnoughBio"),
            InlineKeyboardButton("• Support •", url="https://t.me/DevilsHeavenMF"),
        ],
        [
            InlineKeyboardButton(
                "• Repo •", url="https://github.com/FabinoXD/xDspam"
            )
        ],
    ]
)
